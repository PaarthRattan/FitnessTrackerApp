...
public class ExerciseProgramGUI extends javax.swing.JFrame {
    ...
    private void butGymActionPerformed(java.awt.event.ActionEvent evt) {                                       
    ...
    private void txtGymAvailabilityActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        // TODO add your handling code here:
    }                                                  

    // This method handles user input for minimum and maximum calories, validates them, and displays exercises within the specified range
    private void butCaloriesActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        if (minCalories < 0 || maxCalories < 0) { // if the user enters improper inputs for calories, the following will be shown in the txtUpdate so the user is known of the issue 
            txtUpdate.setText("Please enter a valid positive number for calories");
            } else if (minCalories < 99 || maxCalories > 1000) {
                txtUpdate.setText("Please enter numbers between 100 and 999 for calories per hour respectively for min and max");
                ...
                txtUpdate.setText("Please enter a higher number for minimum calories!");
            } else {
    ...
    private void txtMinCaloriesActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void txtMaxCaloriesActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void butCategoryActionPerformed(java.awt.event.ActionEvent evt) {                                            
